...
*	4: _count 		<ARRAY> - [1,3,5]
*	5: _name 		<STRING> - Refer loadout hpp files
*   
*   Example:
*   [500, ["lost_hope_zombie_vanilla_police", "lost_hope_zombie_vanilla_civilians", "lost_hope_zombie_vanilla_military"], getPosATL player, EAST, "Military"] call lost_hope_fnc_markerSetup;
*
*	Return Value: None
*/

params ["_distance", "_group", "_position", "_side", "_count", "_name"];
