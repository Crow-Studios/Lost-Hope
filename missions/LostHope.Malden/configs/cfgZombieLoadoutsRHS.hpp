	...
	class lost_hope_zombie_vanilla_civilians
	{
		class lost_hope_zombie
		{
			primary[] = {""};
			secondary[] = {""};
			uniform[] = {"rhs_uniform_gorka_r_g", "rhs_uniform_gorka_r_y_gloves", "rhs_uniform_afghanka_grey", "rhs_uniform_flora_patchless_alt"};
			vest[] = {""};
			backpack[] = {"rhs_medic_bag", "rhs_rd54", "rhs_sidor"};
			headgear[] = {"rhs_6m2_1", "rhs_beanie_green", "rhs_fieldcap_m88_grey_back", "rhs_pilotka", "rhs_ushanka"};
			facewear[] = {};
			nvg = "";
		...
		class lost_hope_zombie_melee
		{
			...
			backpack[] = {"rhs_medic_bag", "rhs_rd54", "rhs_sidor"};
			headgear[] = {"rhs_6m2_1", "rhs_beanie_green", "rhs_fieldcap_m88_grey_back", "rhs_pilotka", "rhs_ushanka"};
			facewear[] = {"rhs_scarf", "rhs_balaclava", "rhsusf_shemagh2_od"};
			nvg = "";
			binoculars = "Binocular";
			map = "ItemMap";
			terminal = "ItemGPS";
		...
		{
			primary[] = {"hlc_rifle_ak47"};
			secondary[] = {"rhs_weap_pya"};
			uniform[] = {"rhs_uniform_gorka_r_g", "rhs_uniform_gorka_r_y_gloves", "rhs_uniform_afghanka_grey", "rhs_uniform_flora_patchless_alt"};
			vest[] = {"rhs_6b23_vydra_3m", "rhs_6b23_ML_6sh92_vog_headset", "rhs_6b3_VOG_2"};
			backpack[] = {"rhs_rpg_2", "rhs_rk_sht_30_emr_engineer_empty", "I_E_HMG_01_support_F"};
			headgear[] = {"rhs_6m2_1", "rhs_beanie_green", "rhs_fieldcap_m88_grey_back", "rhs_pilotka", "rhs_ushanka"};
	...
	class lost_hope_zombie_vanilla_farmers
	{
		...
		{
			primary[] = {"rhs_weap_ak74m_desert_npz"};
			secondary[] = {"rhs_weap_pb_6p9", "rhs_weap_6p53", "rhs_weap_pp2000_folded"};
			uniform[] = {"rhs_uniform_6sh122_gloves_v2", "rhs_uniform_6sh122_v2", "rhs_uniform_6sh122_gloves_v1"};
			vest[] = {"rhs_6sh92_digi_headset", "rhs_6sh92_digi_radio", "rhs_belt_AK_back"};
			backpack[] = {""};
			headgear[] = {"rhs_6m2_1", "rhs_beanie_green", "rhs_fieldcap_m88_grey_back", "rhs_pilotka", "rhs_ushanka"};
			facewear[] = {"G_Respirator_yellow_F", "G_RegulatorMask_F"};
			nvg = "";
	...
	// Police
	// LEFT OFF HERE, SMALL REMINDER FOR MY BEAN BRAIN!
